...
module.exports = grammar(hcl, {
  ...
  rules: {
    ...
    resource_service_map: ($) => choice(
      ...
      alias($.chimesdkmediapipelines0, "chimesdkmediapipelines"),
      alias($.chimesdkmeetings0, "chimesdkmeetings"),
      alias($.chimesdkmessaging0, "chimesdkmessaging"),
      alias($.chimesdkvoice0, "chimesdkvoice"),
      alias($.cleanrooms0, "cleanrooms"),
      ...
      alias($.dms0, "dms"),
      alias($.docdb0, "docdb"),
      alias($.docdbelastic0, "docdbelastic"),
      alias($.drs0, "drs"),
      alias($.ds0, "ds"),
      ...
      alias($.securitylake0, "securitylake"),
    ...
    chimesdkmediapipelines0: ($) => /aws_chimesdkmediapipelines_[a-zA-Z_]+/,
    chimesdkmeetings0: ($) => /aws_chimesdkmeetings_[a-zA-Z_]+/,
    chimesdkmessaging0: ($) => /aws_chimesdkmessaging_[a-zA-Z_]+/,
    chimesdkvoice0: ($) => /aws_chimesdkvoice_[a-zA-Z_]+/,
    cleanrooms0: ($) => /aws_cleanrooms_[a-zA-Z_]+/,
    ...
    docdbelastic0: ($) => /aws_docdbelastic_[a-zA-Z_]+/,
    ...
    ec21: ($) => /aws_(ami|availability_zone|ec2_(availability|capacity|fleet|host|instance|public_ipv4_pool|serial|spot|tag)|eip|instance|key_pair|launch_template|placement_group|spot)/,
    ...
    securitylake0: ($) => /aws_securitylake_[a-zA-Z_]+/,
    ...
    ec26: ($) => /aws_route/,
    vpclattice0: ($) => /aws_vpclattice_[a-zA-Z_]+/,
    ec27: ($) => /aws_vpc_ipam/,
